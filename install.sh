...
let sections = [
    Section(title: "Workspaces", color: mauve, rows: [
        Row(key: "⌥ 1-0", action: "Switch workspace"),
        Row(key: "⌥ ⇧ 1-0", action: "Move and follow"),
        Row(key: "⌥ ⇧ ⌃ 1-0", action: "Move without follow"),
        Row(key: "⌥ Tab", action: "Next workspace"),
        Row(key: "⌥ ⇧ Tab", action: "Previous workspace"),
        Row(key: "⌥ ⌘ Tab", action: "Former workspace"),
    ]),
    Section(title: "Focus", color: blue, rows: [
        Row(key: "⌥ Arrows", action: "Focus direction"),
    ...
    Section(title: "Move", color: green, rows: [
        Row(key: "⌥ ⇧ Arrows", action: "Swap window"),
        Row(key: "⌥ ⇧ ⌃ Arrows", action: "Move monitor"),
    ]),
    Section(title: "Resize", color: peach, rows: [
        Row(key: "⌥ - / =", action: "Width down / up"),
