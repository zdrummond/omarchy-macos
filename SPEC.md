...
- **Bar visibility defaults off.** SketchyBar starts hidden and toggles with `⌥ + Z`; switching workspaces hides it again. Press-to-peek is disabled because the modifier polling/repaint path can make SketchyBar unresponsive on multi-monitor setups.
